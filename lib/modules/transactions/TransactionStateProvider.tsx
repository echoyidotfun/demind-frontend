...
export const TransactionStateContext =
  createContext<TransactionStateResponse | null>(null);

export function TransactionStateProvider({ children }: PropsWithChildren) {
  const hook = _useTransactionState();

  return (
    <TransactionStateContext.Provider value={hook}>
      {children}
