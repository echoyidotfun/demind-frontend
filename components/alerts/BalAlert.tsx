...
import { FiAlertTriangle, FiCheck, FiLoader, FiXOctagon } from "react-icons/fi";
  ...
  return (
    <Alert rounded={isNavAlert ? "none" : "default"} status={status} {...rest}>
      {ssr ? (
        ...
        <AlertIcon as={getAlertIcon(status)} {...iconSize} />
      )}
      ...
      {learnMoreLink && (
        <BalAlertButtonLink href={learnMoreLink}>More</BalAlertButtonLink>
      )}
      {isSoftWarning && (
        <CloseButton
          _hover={{
