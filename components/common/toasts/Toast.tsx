...
import { GoArrowUpRight, GoCheck, GoX } from "react-icons/go";
      ...
      <Box {...contentStyles}>
          ...
          <>
            ...
            >
              <IconButton
                ...
                h="6"
                href={linkUrl}
                icon={<GoArrowUpRight size={12} strokeWidth={3} />}
                position="absolute"
                right="8"
                size="xs"
                target="_blank"
        ...
        {isClosable && (
          <IconButton
            ...
            h="6"
            icon={<GoX size={12} strokeWidth={3} />}
            onClick={closeToast}
            position="absolute"
            right="xs"
            size="xs"
