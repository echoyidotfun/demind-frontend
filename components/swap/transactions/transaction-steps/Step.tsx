...
import {
  StepProps,
  getStepSettings,
} from "@/lib/modules/transactions/getStepSettings";
...
export function StepIndicator({
  ...
  const { color, isActive, isActiveLoading, status, stepNumber } =
    getStepSettings(props, transaction);
